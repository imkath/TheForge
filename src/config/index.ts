...
export const VERTICALS: Vertical[] = [
  ...
  // ============================================
  {
    ...
    searchKeywords: [
      'launched my saas $5k MRR',
      'indie hacker making $10k month',
      'bootstrapped to $100k ARR',
      'quit job solo founder revenue',
      'side project paying bills now',
      'launched producthunt customers paying',
    ],
  ...
  },
  {
    ...
    searchKeywords: [
      'launched scheduling tool smb',
      'crm small business solo founder',
      'invoicing app freelancers launched',
      'booking system independent professionals',
      'client portal software agencies',
      'form builder alternative typeform indie',
    ],
    platforms: ['betalist', 'producthunt', 'hackernews'],
    leadUserPatterns: [
      'wish there was in spanish',
      'no spanish version',
      'english only',
      'US market only',
    ],
  },
  {
    ...
    searchKeywords: [
      'billing saas launched small business',
      'expense tracker app solo founder',
      'invoice generator making money indie',
      'subscription management tool launched',
      'payment link tool stripe alternative',
      'financial dashboard freelancer saas',
    ],
  ...
  },
  {
    ...
    searchKeywords: [
      'newsletter platform gumroad alternative',
      'digital download store creator',
      'online course platform indie maker',
      'membership site builder simple',
      'link in bio tool monetization',
      'tip jar platform creators indie',
    ],
    platforms: ['betalist', 'producthunt', 'indiehackers'],
    leadUserPatterns: [
      'gumroad alternative',
      'substack limitation',
      'teachable workaround',
      'patreon alternative',
    ],
  },
